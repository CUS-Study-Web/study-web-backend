...
class UserExceptionTest {
  ...
  void errorCode_exposesCodeMessageHttpStatus() {
    ...
    assertThat(UserErrorCode.ROLE_NOT_ALLOWED.httpStatus()).isEqualTo(HttpStatus.FORBIDDEN);
    ...
    assertThat(UserErrorCode.NOT_VIP.httpStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
  }

...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        String firstError = errors.values().stream().findFirst()
                .orElse(SystemErrorCode.VALIDATION_ERROR.message());
    ...
    public ResponseEntity<ErrorResponse> handleBindException(BindException ex) {
        ...
        ErrorResponse response = new ErrorResponse(SystemErrorCode.VALIDATION_ERROR.httpStatus().value(),
                SystemErrorCode.VALIDATION_ERROR.message(), SystemErrorCode.VALIDATION_ERROR.code());
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotSupported(HttpRequestMethodNotSupportedException ex) {
        ...
        ErrorResponse response = new ErrorResponse(SystemErrorCode.METHOD_NOT_ALLOWED.httpStatus().value(),
                SystemErrorCode.METHOD_NOT_ALLOWED.message(), SystemErrorCode.METHOD_NOT_ALLOWED.code());
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(NoHandlerFoundException ex) {
        ...
        ErrorResponse response = new ErrorResponse(SystemErrorCode.RESOURCE_NOT_FOUND.httpStatus().value(),
                SystemErrorCode.RESOURCE_NOT_FOUND.message(), SystemErrorCode.RESOURCE_NOT_FOUND.code());
    ...
    public ResponseEntity<ErrorResponse> handleDatabaseException(DataAccessException ex) {
        ...
        ErrorResponse response = new ErrorResponse(SystemErrorCode.DATABASE_ERROR.httpStatus().value(),
                SystemErrorCode.DATABASE_ERROR.message(), SystemErrorCode.DATABASE_ERROR.code());
    ...
    public ResponseEntity<ErrorResponse> handleMultipartException(MultipartException ex) {
        ...
        ErrorResponse response = new ErrorResponse(SystemErrorCode.INVALID_MULTIPART.httpStatus().value(),
                SystemErrorCode.INVALID_MULTIPART.message(), SystemErrorCode.INVALID_MULTIPART.code());
    ...
    public ResponseEntity<ErrorResponse> handleAccessDenied(AccessDeniedException ex) {
        ...
        ErrorResponse response = new ErrorResponse(SystemErrorCode.FORBIDDEN.httpStatus().value(),
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
        ...
        ErrorResponse response = new ErrorResponse(SystemErrorCode.INTERNAL_ERROR.httpStatus().value(),
                SystemErrorCode.INTERNAL_ERROR.message(), SystemErrorCode.INTERNAL_ERROR.code());

...
public class AuthServiceImpl implements AuthService {
    ...
    public void forgetPassword(ForgetPasswordRequest request) {
        ...
        passwordResetTokenRepository.findById(request.gmail()).ifPresent(existing -> {
        ...
        PasswordResetOtp passwordResetOtp = PasswordResetOtp.builder().gmail(request.gmail())
                .otpCode(passwordEncoder.encode(otpCode)).attempts(0).createdAt(System.currentTimeMillis())
                .ttl(otpExpirationSeconds).build();
    ...
    public void resetPassword(ResetPasswordRequest request) {
        ...
        PasswordResetOtp passwordResetOtp = passwordResetTokenRepository.findById(request.gmail())
        ...
        if (!passwordEncoder.matches(request.otpCode(), passwordResetOtp.getOtpCode())) {
            ...
            log.warn("Invalid OTP for gmail: {}. Remaining attempts: {}", request.gmail(), remainingAttempts);

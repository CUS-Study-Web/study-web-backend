...
public class CourseServiceImpl implements CourseService {
  ...
  public void doneLesson(UUID courseId, UUID subjectId, UUID lessonId, String email) {
    ...
    long completedLessons =
        userLessonProgressRepository.countByUserIdAndLesson_Subject_IdAndIsClickedTrue(
    ...
    log.info(
        "Marked lesson {} done for user {}. Subject {} progress: {}%",
        lessonId, email, subjectId, progressPercent);
  }

...
public record UpdateHomepageRequest(
    ...
    @Size(max = 255, message = "Headline 1 must not exceed 255 characters")
    String headline1,

    @Size(max = 255, message = "Headline 2 must not exceed 255 characters")
    String headline2,
    ...
    @Size(max = 50, message = "Stat 2 number must not exceed 50 characters")
    String stat2Number,

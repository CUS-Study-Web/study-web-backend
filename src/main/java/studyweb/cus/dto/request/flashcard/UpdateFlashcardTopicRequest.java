...
public record UpdateFlashcardTopicRequest(
    @Schema(description = "Topic title", example = "IELTS Academic Vocabulary Advanced")
    ...
    @Schema(description = "Topic description", example = "Updated description")
        String description,
    @Schema(description = "Topic status (DRAFT, PUBLISH, DEVELOPING)", example = "PUBLISH")
